...
namespace Projekt {
    ...
    public partial class db_projectDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductDataTable : global::System.Data.TypedTableBase<ProductRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductRow AddProductRow(string Name, int Amount, string Description, double Price) {
...
namespace Projekt.db_projectDataSetTableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Product] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ((@IsNull_Amount = 1 AND [Amount] IS NULL) OR ([Amount] = @Original_Amount)) AND ((@IsNull_Description = 1 AND [Description] IS NULL) OR ([Description] = @Original_Description)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Product] ([Name], [Price], [Amount], [Description]) VALUES (@N" +
                "ame, @Price, @Amount, @Description);\r\nSELECT Id, Name, Price, Amount, Descriptio" +
                "n FROM Product WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Product] SET [Name] = @Name, [Price] = @Price, [Amount] = @Amount, [Description] = @Description WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ((@IsNull_Amount = 1 AND [Amount] IS NULL) OR ([Amount] = @Original_Amount)) AND ((@IsNull_Description = 1 AND [Description] IS NULL) OR ([Description] = @Original_Description)));
SELECT Id, Name, Price, Amount, Description FROM Product WHERE (Id = @Id)";
        ...
        public virtual int Fill(db_projectDataSet.ProductDataTable dataTable) {
        ...
        public virtual db_projectDataSet.ProductDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            db_projectDataSet.ProductDataTable dataTable = new db_projectDataSet.ProductDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(db_projectDataSet.ProductDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, double Original_Price, global::System.Nullable<int> Original_Amount, string Original_Description) {
        ...
        public virtual int Insert(string Name, double Price, global::System.Nullable<int> Amount, string Description) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, double Price, global::System.Nullable<int> Amount, string Description, int Original_Id, string Original_Name, double Original_Price, global::System.Nullable<int> Original_Amount, string Original_Description, int Id) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, double Price, global::System.Nullable<int> Amount, string Description, int Original_Id, string Original_Name, double Original_Price, global::System.Nullable<int> Original_Amount, string Original_Description) {
            return this.Update(Name, Price, Amount, Description, Original_Id, Original_Name, Original_Price, Original_Amount, Original_Description, Original_Id);
        }
    }
